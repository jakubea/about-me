...
filledSvg : List (Svg msg) -> Html msg
filledSvg =
    Svg.svg
        [ SvgAttributes.css
            [ CssUtil.widthPx defaultIconSize
            , CssUtil.heightPx defaultIconSize
            , Layout.displayInlineBlock
            , CssUtil.verticalAlignMiddle
            ]
        , Attributes.attribute "aria-hidden" "true"
        , Attributes.attribute "focusable" "false"
        , SvgAttributes.fill "currentColor"
        , SvgAttributes.viewBox "0 0 24 24"
        ]


strokedSvg : List (Svg msg) -> Html msg
strokedSvg =
    Svg.svg
        [ SvgAttributes.css
            [ CssUtil.widthPx defaultIconSize
